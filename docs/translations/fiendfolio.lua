...
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.OPHIUCHUS, "Wiggly snake familiar that chases after enemies, inflicting poison and dealing damage on contact#Prioritizes chasing after enemies that are not currently inflicted with poison", "뱀주인자리", "ko_kr")
