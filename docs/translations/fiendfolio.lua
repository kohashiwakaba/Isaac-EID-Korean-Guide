...
-- Birthright
EID:addBirthright(FiendFolio.PLAYER.FIEND, "Fiend의 파이어볼이 적에게 유도되며;#발사 시 지나간 자리에 불길을 남기며;#폭파 시 적 처치 여부와 관계없이 33%의 확률로 Fiend의 부하를 추가로 소환합니다.", "Fiend", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.OBSIDIAN_GRINDSTONE, "{{DamageSmall}}공격력/{{TearsSmall}}연사가 증가하며 다른 장신구를 같이 들고 있을 경우 추가로 증가합니다.#눈물을 10번 발사할 때마다 "..FiendFolio.ITEM.ROCK.POCKET_SAND.."Pocket Sand를 제외한 소지 중인 다른 장신구를 바꿉니다.#!!! 석기 장신구 : 일반 타입", "흑요석 숫돌", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.RAMBLIN_OPAL, "적이 있는 방에서 주기적으로 아군 Shiitake Spore를 최대 3마리까지 소환합니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.SANDSTONE, "확률적으로({{LuckSmall}}) 캐릭터와 가까울수록 공격력이 4배 증가하며 멀어질수록 0배로 감소, 적에게 {{Confusion}}혼란을 거는 거대한 돌덩이를 발사합니다..#폭발 피해를 받으면 "..FiendFolio.ITEM.ROCK.POCKET_SAND.."Pocket Sand로 바뀝니다.#!!! 석기 장신구 : 일반 타입", "사암", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.VESSEL_ROCK, "소지 시 임시 체력의 역할을 하며 비어 있는 상태에서 피격 시 "..FiendFolio.ITEM.ROCK.POCKET_SAND.."Pocket Sand로 바뀝니다.#체력 거래에 사용할 수 없습니다.#{{EmptyHeart}} 현재 비어 있음#!!! 석기 장신구 : 일반 타입", "돌 그릇", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.HALF_VESSEL_ROCK, "소지 시 임시 체력의 역할을 하며 비어 있는 상태에서 피격 시 "..FiendFolio.ITEM.ROCK.POCKET_SAND.."Pocket Sand로 바뀝니다.#체력 거래에 사용할 수 없습니다.#{{HalfHeart}} 현재 반칸 채워짐#!!! 석기 장신구 : 일반 타입", "돌 그릇", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.FULL_VESSEL_ROCK, "소지 시 임시 체력의 역할을 하며 비어 있는 상태에서 피격 시 "..FiendFolio.ITEM.ROCK.POCKET_SAND.."Pocket Sand로 바뀝니다.#체력 거래에 사용할 수 없습니다.#{{FullHeart}} 현재 한칸 채워짐#!!! 석기 장신구 : 일반 타입", "돌 그릇", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.SHEEP_ROCK, "확률적으로({{LuckSmall}}) 눈물이 체공하며 다른 눈물과 부딪힐 시 서로 튕겨나가며 움직입니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK4, "한 방향으로 캐릭터의 공격력의 눈물을 계속 발사합니다.#내려놓거나 다시 주울 때마다 방향을 바꿀 수 있습니다.#내려놓은 상태에서도 동작합니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.FOCUS_CRYSTAL, "캐릭터와 {{ColorYellow}}2.5 타일{{CR}} 내에 있는 적은{{ColorYellow}}20%{{CR}}의 추가 피해를 받습니다. {{ColorGray}}(중첩 당 +20% 복리 증가).{{CR}}#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.ODDLY_SMOOTH_STONE, "{{BlendedHeart}} 하트류 픽업의 획득량이 반칸만큼 추가로 증가합니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.MOONSTONE, "소지한 상태에서 {{SecretRoom}}{{SuperSecretRoom}}비밀방 진입 시 아래 능력치 중 하나 증가:#{{TearsSmall}}/{{RangeSmall}} /{{ShotspeedSmall}}/{{LuckSmall}}#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.LIMESTONE, "캐릭터가 지나간 자리에 초록 장판이 생기며 닿은 적은 초당 캐릭터의 공격력 x0.5의 피해를 입습니다.#감귤 타입의 적을 아군으로 만듭니다.#일부 몬스터가 특수하게 변경됩니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.CARNAL_CARNELIAN, "적과 가까울수록 {{DamageSmall}}공격력/{{SpeedSmall}}이동속도가 증가합니다..#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.REBAR_ROCK, "#{{Heart}}{{ColorYellow}}빨간하트{{CR}} 피해를 25%의 확률로 무시하며 항상 반칸으로 줄여줍니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
EID:addTrinket(FiendFolio.ITEM.ROCK.STALACTITE, "폭발성 피격 시 캐릭터의 공격력 x2의 피해를 주는 돌덩이 여러개가 랜덤 위치에 떨어집니다.#떨어지는 돌덩이에 피해를 입지 않습니다.#!!! 석기 장신구 : 일반 타입", "", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.ROCK.SACK_FOSSIL, "Chance to reroll pickups into sacks#Spawns a sack when crushed#!!! 석기 장신구 : {{ColorRed}}화석{{CR}} 타입", "자루 화석", "ko_kr")
