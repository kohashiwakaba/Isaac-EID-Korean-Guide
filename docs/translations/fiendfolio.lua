...
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.GRABBER, "캐릭터의 반대로 움직이며 캐릭터가 있는 방향으로 손을 움직입니다.#잡는 손에 닿은 적은 5의 피해를 입습니다.", "", "ko_kr")
...
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.LEFTOVER_TAKEOUT, "↑ {{Heart}}최대 체력 +1#↑ {{DamageSmall}}공격력 배율 x1.5#↑ {{TearsSmall}}공격 딜레이 x0.9#↑ {{RangeSmall}}사거리 +1.5#↑ {{SpeedSmall}}이동속도 +0.3#↑ {{LuckSmall}}행운 +1#확률적으로({{LuckSmall}}) 적에게 명중 시 운세를 보여주는 눈물을 발사합니다.", "먹다 남은 배달 음식", "ko_kr")
...
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.FIEND_HEART, "↑ {{FFImmoralHeartTint}}{{SoulHeart}}이모럴하트 +3#{{FFImmoralHeartTint}}{{SoulHeart}}이모럴하트 소지 상태에서 피격 시 모든 {{FFImmoralHeartTint}}{{SoulHeart}}가 Fiend의 부하로 바뀌며 방 클리어 시 바뀐 부하는 다시 {{FFImmoralHeartTint}}{{SoulHeart}} 픽업으로 돌아옵니다.", "", "ko_kr")
...
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.PLANET_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "행성 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.HAUNTED_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "유령 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.BABY_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "아기 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.COMMISSIONED_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "커미션 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.DRIPPING_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "드립 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.MYSTERY_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "미스테리 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.SPATULA_BADGE, "↑ {{DamageSmall}}공격력 +0.1", "주걱 배지", "ko_kr")
EID:addCollectible(FiendFolio.ITEM.COLLECTIBLE.YOUR_ETERNAL_REWARD, "↑ {{DamageSmall}}공격력 +0.1", "완성 보상", "ko_kr")
...
EID:addTrinket(FiendFolio.ITEM.TRINKET.FAULTY_FUSE, "{{FFCopperBombTint}}{{Bomb}}구리폭탄이 등장할 확률이 증가합니다.#{{Collectible106}} {{FFCopperBombTint}}{{Bomb}}구리폭탄은 일반 폭탄보다 범위와 공격력이 더 큽니다.", "끊어진 퓨즈", "ko_kr")
