--[[ 
	...
	The Collection Collections by Preyn
	Includes all 6 collection mods
...
-- DO NOT TOUCH
{ LANG = "ko_kr", NAME = "취급주의", DESC = "일반 방 진입 시 15%의 확률로 랜덤 위치에 빨간 버튼이 생성됩니다." },
-- Fettered heart
{ LANG = "ko_kr", NAME = "구속된 심장", DESC = "적들이 15%의 확률로 구속 상태에 걸립니다.#구속된 적 피격 시 방 안의 모든 적들도 80%의 피해를 받습니다." },
-- Lil heretic
{ LANG = "ko_kr", NAME = "리틀 불신자", DESC = "적을 따라다니며 접촉하는 적을 {{Weakness}}약화시킵니다.#캐릭터 사이에 레이저가 연결됩니다." },
-- Mended knife
{ LANG = "ko_kr", NAME = "완성된 칼 조각", DESC = "공격하는 방향으로 칼을 날릴 수 있습니다.#!!! 특정 스테이지로 가는 문을 열 수는 없습니다." },
-- Papyrus rags
...
-- Crackling slag
{ LANG = "ko_kr", NAME = "딱딱한 광재", DESC = "눈물 발사 시 30%의 확률로 해당 눈물이 지나가는 자리에 불꽃을 소환합니다.#!!! {{Luck}}행운 수치 비례: 행운 15 이상일 때 45% 확률" },
-- Gideon's gaze
...
-- Mini bombs
{ LANG = "ko_kr", NAME = "초 압축 폭탄",  DESC = "{{ArrowUp}} {{Bomb}}폭탄 +10#{{Warning}} 트롤 폭탄이 폭발할 때 20%의 확률로 기가 폭발이 일어납니다.#플레이어가 설치한 모든 폭탄이 기가 폭탄으로 설치됩니다.#!!! (외형 상으로는 작은 폭탄으로 설치됨)" },
-- Pile of bones
...
-- Quake oats
{ LANG = "ko_kr", NAME = "지진 시리얼", DESC = "#!!! 소지 시 적이 있는 방에서 하늘에서 돌덩이가 떨어집니다.#사용 시 하늘에서 돌 무더기를 떨어뜨립니다.#떨어지는 돌의 효과는 플레이어의 눈물 효과의 영향을 받습니다.#{{Battery}} 25%의 확률로 사용 시 충전량을 전부 보존합니다." },
-- Singed stones
...
-- Plastic bag
{ LANG = "ko_kr", NAME = "비닐백", DESC = "적 처치 시 적에게 공격력 x1.5의 피해를 주는 갈색 장판을 생성됩니다.#적 처치 시 6%의 확률로 똥 폭탄이 설치됩니다." },
-- Slippy tooth
