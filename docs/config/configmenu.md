...
| **Obstructed Card Infos** | 장애물에 가로막힌 카드/룬의 설명을 보여줍니다. | `false` |
| **Obstructed Pill Infos** | 장애물에 가로막힌 알약의 설명을 보여줍니다. | `true` |
| **Obstructed Soulsotne Infos** | 장애물에 가로막힌 영혼석의 설명을 보여줍니다. | `true` |
...
| 옵션 | 설명 | 기본값 |
| ------------ | ------------- | ------------- |
| **Item Reminder Description** | 특정 키를 누른 상태에서 리마인더를 보여줍니다. | `true` |
| **Options** ||
